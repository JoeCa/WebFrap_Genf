 ...
 * @subpackage Genf
 */
class LibGeneratorDmodelAttributeReference
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildSetupField( $attribute )
  {
    ...
    $package = $this->builder->projectNode->getMainPackage();

    if(!$target = $attribute->targetManagement())
    {
      // nicht vorhandene referenzen werden einfach ausgeblendet
      return '';
    }
    ...
    */
    ...
    $code = "{$name}: {$package}.{$target->name->class} {$description}".NL;
...
} // end class LibGeneratorDmodelAttributeReference
