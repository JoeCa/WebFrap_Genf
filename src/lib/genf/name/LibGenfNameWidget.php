...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function parse( $name , $params = array() )
  {
    ...
    $this->class         = SParserString::subToCamelCase($class);
    
    $this->classPostfix  = '_Widget';
    ...
    if( isset( $name['module'] ) )
      ...
      $this->customModul = 'profiles';
      
    if( isset( $name['mask'] ) )
      $this->mask = trim($name['mask'] );
    else 
    ...
    if( isset( $name['type'] ) )
    {
      ...
      $this->widget = SParserString::subToCamelCase($this->type);
    }
