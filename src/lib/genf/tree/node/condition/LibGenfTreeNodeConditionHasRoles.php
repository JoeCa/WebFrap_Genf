 ...
 * 
 */
class LibGenfTreeNodeConditionHasRoles
...
//////////////////////////////////////////////////////////////////////////////*/
   ...
   */
  public function getRoleConstraints()
  {
    ...
    foreach( $this->node->roles->role as $role )
    {
      $roles[] = new LibGenfTreeNodeConstraintRole( $role ) ;
    }
    
    return $roles;

  }//end public function getRoleConstraints */
