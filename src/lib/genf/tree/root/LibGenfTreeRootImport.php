...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('imports');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/imports/import[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query( '/bdl/imports/import' );

    if( !$className  = $this->builder->getNodeClass( 'Import' ) )
    {
      throw new LibGenfTree_Exception( 'Got no Node for Import' );
    }
  ...
  /**
   * @param LibGenfTreeNodeImport $import
   * @return LibGenfEnvImport
   */
  public function createEnvironment( $import )
  {

    $environment = new LibGenfEnvImport( $this->builder, $import );
  ...
  public function get( $name, $type = null )
  {
    ...
    $check    = '/bdl/imports/import[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootImport
