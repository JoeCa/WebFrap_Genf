 ...
 * @subpackage GenF
 */
class LibGenfTreeRootNavigation
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('navigations');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    $nodeQuery  = '//navigations/navigation';
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '//navigations/navigation[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('//navigations/navigation');

    if(!$className  = $this->builder->getNodeClass('Navigation'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Gateway' );
    }
  ...
  {
    $check    = '//navigations/navigation[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootGateway
