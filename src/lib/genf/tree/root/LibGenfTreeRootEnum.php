...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    Debug::console( "in preProcessing enums" );
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('enums');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    $componentRoot = $this->builder->getComponentRoot();
    ...
    */
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/enums/enum[@name="'.$nodeName.'"]';
  ...
  <component 
    ...
    <data_source type="enum" />

  </component>

XMLS;

      $componentRoot->add( $xml );
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/enums/enum');

    if(!$className  = $this->builder->getNodeClass('Enum'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Enum' );
    }
    ...
    foreach( $nodeList as $node )
    {
      ...
      $enum     = new $className($smplNode);
      
      // create an entity index in the node
      $this->nodes[trim($smplNode['name'])] = $enum;
  ...
  {
    $check    = '/bdl/enums/enum[@name="'.$name.'"]';
