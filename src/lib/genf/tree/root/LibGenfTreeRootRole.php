...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('roles');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/roles/role[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/roles/role');

    if(!$className  = $this->builder->getNodeClass('Role'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Role' );
    }
  ...
  {
    $check    = '/bdl/roles/role[@name="'.$name.'"]';
