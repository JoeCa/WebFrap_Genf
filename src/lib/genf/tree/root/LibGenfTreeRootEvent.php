...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('events');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/events/event[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/events/event');

    if(!$className  = $this->builder->getNodeClass('Event'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Event' );
    }
  ...
  {
    $check    = '/bdl/events/event[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootEvent
