...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('skeletons');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    $nodeQuery  = '/bdl/skeletons/skeleton';
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/skeletons/skeleton[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/skeletons/skeleton');

    if(!$className  = $this->builder->getNodeClass('Skeleton'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Skeleton' );
    }
  ...
  /**
   * (non-PHPdoc)
   * @see src/lib/genf/tree/LibGenfTreeRootSkeleton#get()
   */
  public function get( $name, $type = null )
  {
    $check    = '/bdl/skeletons/skeleton[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootSkeleton
