...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('widgets');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/widgets/widget[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/widgets/widget');

    if(!$className  = $this->builder->getNodeClass('Widget'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Widget' );
    }
  ...
  /**
   * (non-PHPdoc)
   * @see src/lib/genf/tree/LibGenfTreeRootWidget#get()
   */
  public function get( $name, $type = null )
  {
    $check    = '/bdl/widgets/widget[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootWidget
