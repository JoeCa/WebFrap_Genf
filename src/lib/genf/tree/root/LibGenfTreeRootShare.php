...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('shares');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/shares/share[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query( '/bdl/shares/share' );

    if( !$className  = $this->builder->getNodeClass( 'Share' ) )
    {
      throw new LibGenfTree_Exception( 'Got no Node for Share' );
    }
  ...
  /**
   * @param LibGenfTreeNodeShare $share
   * @return LibGenfEnvShare
   */
  public function createEnvironment( $share )
  {

    $environment = new LibGenfEnvShare( $this->builder, $share );
  ...
  public function get( $name, $type = null )
  {
    ...
    $check    = '/bdl/shares/share[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootShare
