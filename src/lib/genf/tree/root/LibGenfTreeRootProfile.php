...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    Debug::console( "in preProcessing profiles" );

    $checkRoot  = '/bdl/profiles';
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('profiles');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    $nodeQuery  = '/bdl/profiles/profile';
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/profiles/profile[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/profiles/profile');

    if(!$className  = $this->builder->getNodeClass('Profile'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Profile' );
    }
  ...
  {
    $check    = '/bdl/profiles/profile[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootProfile
