...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('gateways');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    $nodeQuery  = '/bdl/gateways/gateway';
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/gateways/gateway[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/gateways/gateway');

    if(!$className  = $this->builder->getNodeClass('Gateway'))
    {
  ...
  {
    $check    = '/bdl/gateways/gateway[@name="'.$name.'"]';
