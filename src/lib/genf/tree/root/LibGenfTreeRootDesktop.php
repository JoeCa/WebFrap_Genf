...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement('desktops');
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    $nodeQuery  = '/bdl/desktops/desktop';
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/desktops/desktop[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query('/bdl/desktops/desktop');

    if(!$className  = $this->builder->getNodeClass('Desktop'))
    {
      throw new LibGenfTree_Exception( 'Got no Node for Desktop' );
    }
  ...
  {
    $check    = '/bdl/desktops/desktop[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootDesktop
