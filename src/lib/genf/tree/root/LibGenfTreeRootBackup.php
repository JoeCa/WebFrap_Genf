...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function preProcessing()
  {
    ...
    {
      $this->nodeRoot = $this->modelTree->createElement( 'backups' );
  ...
  public function importFile(  $tmpXml, $tmpXpath, $repoPath = null  )
  {
    ...
    */
    ...
    foreach( $nodeList as $node )
    {
      ...
      $checkQuery   = '/bdl/backups/backup[@name="'.$nodeName.'"]';
  ...
  public function createIndex()
  {
    ...
    $modelXpath     = $this->tree->getXpath();
    $nodeList       = $modelXpath->query( '/bdl/backups/backup' );

    if( !$className  = $this->builder->getNodeClass( 'Backup' ) )
    {
      throw new LibGenfTree_Exception( 'Got no Node for Backup' );
    }
  ...
  public function get( $name, $type = null )
  {
    ...
    $check    = '/bdl/backups/backup[@name="'.$name.'"]';
...
} // end class LibGenfTreeRootBackup
