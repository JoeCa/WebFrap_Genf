...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function build( $cartridge )
  {
    ...
    {
      Error::addError('Requested nonexisting Enum Cartridge: '.$cartridge['class'] );
      return null;
    }

    //Message::addMessage('Using Profile Cartridge: '.$class);
    //Log::info( 'Using Enum Cartridge: '.$class.' '.date('H:i:s') );
    $start = time();
    ...
    Log::info( 'Build Enum Cartridge: '.$class.' in '. (time()-$start).' seconds' );

    return $parser;

  }//end public function build */

} // end class LibGenfBuildEnum
