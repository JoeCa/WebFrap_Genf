...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function build( $cartridge )
  {
    ...
    //Message::addMessage('Using Gateway Cartridge: '.$class);
    //Log::info( 'Using Gateway Cartridge: '.$class.' '.date('H:i:s') );
    $start = time();
    ...
    Log::info( 'Build Gateway Cartridge: '.$class.' in '. (time()-$start).' seconds' );

    return $parser;

  }//end public function build */

} // end class LibGenfBuildGateway
