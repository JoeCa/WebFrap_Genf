...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function build( $cartridge )
  {
    ...
    //Message::addMessage( 'Using Module Cartridge: '.$class );
    //Log::info( 'Using Module Cartridge: '.$class.' '.date('H:i:s') );
    $start = time();
    ...
    Log::info( 'Build Module Cartridge: '.$class.' in '. (time()-$start).' seconds' );

    return $parser;

  } // end public function build */

} // end class LibGenfBuildModule
