...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function build( $cartridge )
  {
    ...
    //Message::addMessage( 'Using Component Cartridge: '.$class );
    //Log::info( 'Using Component Cartridge: '.$class.' '.date('H:i:s') );
    $start = time();
    ...
    Log::info( 'Build Component Cartridge: '.$class.' in '. (time()-$start).' seconds' );

    return $parser;

  }//end public function build */

} // end class LibGenfBuildComponent
