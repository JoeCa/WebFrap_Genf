...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function build( $cartridge )
  {
    ...
    {
      Error::addError( 'Requested nonexisting Controll Cartridge: '.$cartridge['class'] );
      return null;
    }

    //Message::addMessage( 'Using Controll Cartridge: '.$class );
    //Log::info( 'Using Controll Cartridge: '.$class.' '.date('H:i:s') );
    $start = time();
...
} // end class LibGenfBuildControll
