...
/**
 * Bei diesem Konzept bekommt der User eines Employees der irgendwo zugewiesen
 * wird auch gleich die staff rolle
 * 
 * @package WebFrap
 * @subpackage GenF
 */
class LibGenfConceptEmployeeStaffing
...
} // end class LibGenfConceptStaffable
