...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function compile( $rawCode  )
  {
    ...
    $this->sst          = $this->parser->createSst( $this->lexer );

    $codeCompiler       = $this->registry->getSubCompiler( 'Container' );
    $this->compiledCode = $codeCompiler->compile( $this->sst );
