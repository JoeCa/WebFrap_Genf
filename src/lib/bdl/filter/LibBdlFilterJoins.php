...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function parse(  )
  {
    ...
    {
      if( $this->catch && $token[0] == $this->t_identifier && $this->lexer->preview($this->c_dot) )
      {
...
//////////////////////////////////////////////////////////////////////////////*/
 ...
 /**
  ...
  public function parseEntity( $token  )
  {
    ...
    {
      $this->fail( 'Invalid Filter, used noexisting source: '.$activManagement.' '. __METHOD__ , $token );
    }
  ...
  public function parseEntityPath( $mgmtNode, $attributeToken  )
  {
    ...
    {
      $this->fail( 'Source target '.$mgmtNode.' attribute has no target reference '.$targetAttr->name->name , $attributeToken );
    }

    $this->tableJoins[] = array
    (
      'src'       => $mgmtNode->name->source,
      'srcId'     => $attrName,
      'target'    => $pathManagement->name->source,
      'targetId'  => 'rowid',
      'alias'     => $pathManagement->name->name
    );
    ...
    $this->parseEntityPath( $pathManagement, $attribute );

  }//end public function parseEntity */


} // end class LibBdlFilterJoins
